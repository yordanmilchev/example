...
@section('title')
    Справка транзакции през БОРИКА за период
@endsection
                    ...
                    <div class="col-lg-3">
                        <div class="input-group">
                            ...
                            <select id="status" name="status" class="form-control">
                                <option value="">- БОРИКА статус -</option>
                                @foreach($boricaStatusMessages as $statusMessage)
                                    <option value="{{ $statusMessage }}">{{ $statusMessage }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="kt-section">
                <div class="kt-section__content">
                    ...
                    <div class="table-responsive">
                        {{ $boricaTransactionsForPeriod->appends(request()->query())->links() }}
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center font-weight-bold">Ref Number</th>
                                ...
                                <th class="text-center font-weight-bold">БОРИКА статус</th>
                            </tr>
                            </thead>
                            <tbody>
                            @forelse ($boricaTransactionsForPeriod as $transaction)
                                <tr>
                ...
                <a href="{{ route('admin.report.borica_transactions.export', ['from' => request()->from_date, 'to' => request()->to_date, 'status' => request()->status, 'country' => request()->country]) }}"
