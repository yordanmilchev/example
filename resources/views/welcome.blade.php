            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Log out</a>
        ...
        @foreach ($categoriesTree as $navMenuItem)
            <li class="nav-item">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                   ...
                   aria-expanded="false">{{ $navMenuItem['name'] }}
                    ...
                    <div class="dropdown-menu-items">
                        @if(isset($navMenuItem['children']) && count($navMenuItem['children']))
                            @foreach($navMenuItem['children'] as $parent)
                                <a class="dropdown-toggle" href="/products/{{ $parent['slug'] }}">
                                    <p>{{ $parent['name'] }}</p>
                                </a>
                            @endforeach
                        @endif
